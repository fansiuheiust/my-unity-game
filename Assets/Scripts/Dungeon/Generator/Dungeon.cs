...
namespace Dungeon.Generator {
    ...
    public class Dungeon {
        ...
        /// </summary>
        public List<(RoomType type, Vector3Int[] blocks, Vector3Int center, uint rotation)> GeneratedRooms => rooms.Select(r => (r.Type, r.Blocks.Select(b => b.coordinate).ToArray(), r.Center, r.NormalizedRotation*90)).ToList();
        /// <summary>
